...
const experiences = [{
        ...
        description: "The training taught me the different types of sensors which is been used in the real word. Learned about the working and functionality of Arduino Board and some basic concepts about Iot. Presented an Iot application Idea for monitoring the heart rate of a person via the smartwatch",
    },
    {
        title: "Summer Intern",
        company: "HCLTech",
